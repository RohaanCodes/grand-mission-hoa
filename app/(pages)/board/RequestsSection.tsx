...
import { ListChecks, Rows3, LayoutGrid, List } from 'lucide-react'
...
export default function RequestsSection({
  ...
  return (
    <div className="bg-white border border-slate-100 rounded-2xl shadow-[0_4px_6px_-1px_rgba(148,163,184,0.1),0_2px_4px_-1px_rgba(148,163,184,0.06)] overflow-hidden">
      {/* Colored header band instead of a plain white bar */}
      <div className="bg-blue-600 px-5 sm:px-6 py-4 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="p-5 sm:p-6 bg-slate-50">
        {filtered.length === 0 ? (
          <div className="bg-white border border-slate-100 rounded-lg p-10 text-center">
            <p className="text-slate-400 text-sm">No requests match these filters.</p>
          </div>
        ) : viewMode === 'list' ? (
