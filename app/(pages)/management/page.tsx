...
export const metadata = {
  title: 'Management Dashboard | Grand Mission HOA',
}
...
export default async function ManagementDashboardPage() {
  ...
  // Role is a fixed label here, no Airtable field for it on Management
  // Companies. Photo IS real, from that table's Profile Photo field.
  const mgmtAny = mgmt as any
  const roleLabel = 'Community Manager'
  const photoUrl = mgmtAny.photoUrl as string | undefined

  // Weekly, not lifetime — current calendar week, Sunday through now.
  const now = new Date()
  ...
  const submittedThisWeek = requests.filter((r: any) =>
    inCurrentWeek(r.submitted_date)
  )
        ...
        <section className="max-w-7xl mx-auto px-3 sm:px-6 py-6 sm:py-8">
          ...
          >
            ...
            >
              ...
              {/* ===================================================
                  RIGHT — ANIMATED COMMUNITY MESSAGE
                  =================================================== */}
